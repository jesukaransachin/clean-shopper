...
You are receiving project input in some form, whether a PRD, a brief, bullet points, copy-pasted notes, screenshots, or any combination. Your task is to analyze this input and produce a structured Project Context Document.
...
After generating the project context document, save it as a markdown file at docs/project-context.md in the current project directory. If the docs/ directory does not exist, create it. If docs/project-context.md already exists, ask the user whether to overwrite it or save as a new version (e.g., docs/project-context-v2.md).
